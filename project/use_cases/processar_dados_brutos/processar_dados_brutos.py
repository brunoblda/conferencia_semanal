...
from project.use_cases.interfaces.transformar_arquivos.verificar_existencia_de_arquivo import (
    VerificarExistenciaDeArquivo as VerificarExistenciaDeArquivoInterface,
)
...
class ProcessarDadosBrutos(ProcessarDadosBrutosInterface):
    def __init__(
        ...
        pdf_conversor: PdfConversorInterface,
        criar_output_path: CriarOutputPathInterface,
        verificar_existencia_de_arquivo: VerificarExistenciaDeArquivoInterface,
    ) -> None:
        """Constructor"""
    ...
    def execute(
        self, credentials: dict, input_path: str, output_file_path: str
        ...
        if not self.__verificar_existencia_de_arquivo.execute(dado_processado_path):
            ...
            dado_processado_path = self.__criar_output_path.execute(
                output_file_path, stream_asset
            )
