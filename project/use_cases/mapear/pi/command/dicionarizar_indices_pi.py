        ...
        for w in dict_indices:
            ...
            for z in dict_indices[w]:
                ...
                for y in z:
                    ...
                    nome_elemento_despesa = re.sub(r'[a-zA-ZÀ-ü\s\-\/]', '', plano_interno[1][y].strip())
                    ...
                    if not nome_elemento_despesa:
                        nome_elemento_despesa = re.sub(r'[a-zA-ZÀ-ü\s\-\/]', '',plano_interno[2][y])
                    ...
                    dotacao_elemento_despesa = self.utils.value_hygienization(plano_interno[3][y])
                    ...
                    for x in z[y]:
                        ...
                        nome_desdobramento_despesa = re.search(pattern_desdobramento_elemento_despesa_codigo, plano_interno[1][x])[0] 
                        dotacao_desdobramento_despesa = self.utils.value_hygienization(plano_interno[3][x])
                
                        dict_resultado_plano_interno[nome_plano_interno]['elementos de despesa'][nome_elemento_despesa]['desdobramentos de despesa'][nome_desdobramento_despesa] = {'indice': x, 'valor': dotacao_desdobramento_despesa}
