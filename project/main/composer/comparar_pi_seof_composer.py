...
from project.infra.transformar_arquivos.ocr.criar_output_path_to_pdf_ocr_seof import (
    CriarOutputPathToPdfOcrSeof,
)
from project.infra.transformar_arquivos.ocr.pdf_conversor_to_pdf_ocr_pi import (
    PdfConversorToPdfOcrPi,
)
from project.infra.transformar_arquivos.ocr.pdf_conversor_to_pdf_ocr_seof import (
    PdfConversorToPdfOcrSeof,
)
...
def comparar_pi_seof_composer(request: dict) -> ResponseFormat:
    ...
    processar_dados_bruto_seof = ProcessarDadosBrutos(
        ler_dados_seof,
        pdf_conversor_to_pdf_ocr_seof,
        criar_output_path_to_pdf_ocr_seof,
        verificar_existencia_de_arquivo,
    )
    ...
    mapear_pi_seof = MapearPi(
        dicionarizar_indices_seof, sanitiza_pi_seof, pegar_indices_seof
    )
    ...
    plano_interno_seof_populado = popular_plano_interno_controller_seof.handle_request(
        credentials, input_file_path_secundario, output_file_path_pi_seof
    )
